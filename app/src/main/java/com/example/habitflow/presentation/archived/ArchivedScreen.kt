    ...
    Scaffold(modifier = Modifier
        ...
        Box(
            ...
            when (state) {
                ...
                is ArchivedUiState.Empty -> {
                    Column(
                        ...
                        Text("Нет архивных привычек", fontWeight = FontWeight.SemiBold)
                        Text("Заархивируй первую привычку", color = Color.Gray)
                    }
                }
            ...
            if (habitToDelete != null) {
                AlertDialogForDeleteHabit(
                    onConfirm = {
                        habitToDelete?.let { id -> viewModel.onDelete(id) }
                        habitToDelete=null
                    },
...
fun AlertDialogForDeleteHabit(
    ...
    AlertDialog(
        ...
        text = { Text("Это действие отменить нельзя") },
        confirmButton = {
